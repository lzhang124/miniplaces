...
def AlexNet():
    model = Sequential()
    model.add(Convolution2D(96, (11, 11), strides=(4,4), input_shape=(224,224,3), padding='same'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', default=24, type=int)
    parser.add_argument('-l', '--load', default=False, action='store_true')
    parser.add_argument('-f', '--file', default='alexnet_bn.h5')
